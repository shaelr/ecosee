...
const ALL = { system: true, sensors: true, fan: true, schedule: true, setpoints: true };

describe('toTabBarModel', () => {
  it('lists reachable sections in device order (sensors, fan, Schedule, Setpoints, System-gear) after the badge', () => {
